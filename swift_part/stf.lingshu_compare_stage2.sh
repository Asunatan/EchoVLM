...
swift sft \
    ...
    --output_dir /XYFS01/HOME/sysu_ldchen/sysu_ldchen_1/SonoVLM_V2/checkpoints/simple/compare/stage2/lingshu \
    --dataset_num_proc 8 \
    --deepspeed zero3 \
    --max_length 10240 \
    --resume_from_checkpoint /XYFS01/HOME/sysu_ldchen/sysu_ldchen_1/SonoVLM_V2/checkpoints/simple/compare/stage2/lingshu/v1-20251106-012101/checkpoint-280 \
#    --lora_rank 8 \
#    --lora_alpha 32 \
#    --target_modules all-linear \