...
register_dataset(
    DatasetMeta(
        ms_dataset_id='/data/scy/SCY/SonoVLM_V2/data_generation/Miscellaneous_data/output_json/stage1/balance/25000-200/train',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='/data/scy/SCY/SonoVLM_V2/data_generation/Miscellaneous_data/output_json/stage1/balance/25000-200/val',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='/XYFS01/HOME/sysu_ldchen/sysu_ldchen_1/SonoVLM_V2/dataset/SCY/ablation/train',
...
register_dataset(
    DatasetMeta(
        ms_dataset_id='/XYFS01/HOME/sysu_ldchen/sysu_ldchen_1/SonoVLM_V2/dataset/SCY/ablation/sample_percentage_10',
        dataset_name='ablation_data_percentage_10',
        # split=['validation'],
        # dataset_path='/data/scy/SCY/SonoVLM_V2/dataset/train/stage1',
        preprocess_func=CustomPreprocessor(),
    ))
register_dataset(
    DatasetMeta(
        ms_dataset_id='/XYFS01/HOME/sysu_ldchen/sysu_ldchen_1/SonoVLM_V2/dataset/SCY/ablation/sample_percentage_20',
        dataset_name='ablation_data_percentage_20',
        # split=['validation'],
        # dataset_path='/data/scy/SCY/SonoVLM_V2/dataset/train/stage1',
        preprocess_func=CustomPreprocessor(),
    ))
register_dataset(
    DatasetMeta(
        ms_dataset_id='/XYFS01/HOME/sysu_ldchen/sysu_ldchen_1/SonoVLM_V2/dataset/SCY/ablation/sample_percentage_50',
        dataset_name='ablation_data_percentage_50',
        # split=['validation'],
        # dataset_path='/data/scy/SCY/SonoVLM_V2/dataset/train/stage1',
        preprocess_func=CustomPreprocessor(),
    ))
register_dataset(
    DatasetMeta(
        ms_dataset_id='/XYFS01/HOME/sysu_ldchen/sysu_ldchen_1/SonoVLM_V2/dataset/SCY/ablation/sample_percentage_40',
        dataset_name='ablation_data_percentage_40',
        # split=['validation'],
        # dataset_path='/data/scy/SCY/SonoVLM_V2/dataset/train/stage1',
        preprocess_func=CustomPreprocessor(),
    ))
register_dataset(
    DatasetMeta(
        ms_dataset_id='/XYFS01/HOME/sysu_ldchen/sysu_ldchen_1/SonoVLM_V2/dataset/SCY/ablation/sample_percentage_70',
        dataset_name='ablation_data_percentage_70',
        # split=['validation'],
        # dataset_path='/data/scy/SCY/SonoVLM_V2/dataset/train/stage1',
        preprocess_func=CustomPreprocessor(),
    ))
