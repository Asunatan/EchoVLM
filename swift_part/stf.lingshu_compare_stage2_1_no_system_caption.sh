...
swift sft \
    ...
    --dataset stage_data_new_no_system_caption_2_1 \
    --max_pixels 112896 \
    ...
    --output_dir /XYFS01/HOME/sysu_ldchen/sysu_ldchen_1/SonoVLM_V2/checkpoints/simple/compare/stage2/lingshu_no_system_caption_stage2_1 \
    --dataset_num_proc 8 \
    --deepspeed zero3 \
    --max_length 10240 \
#    --lora_rank 8 \
